...
MODELS = [
    ...
    {
        "model": "openai/gpt-oss-120b",
        "output": "outputs/train-result-gpt-oss/single_preds6.csv",
    },
    {
        "model": "openai/gpt-oss-120b",
        "output": "outputs/train-result-gpt-oss/single_preds7.csv",
    },
    {
        "model": "openai/gpt-oss-120b",
        "output": "outputs/train-result-gpt-oss/single_preds8.csv",
    },
    {
        "model": "openai/gpt-oss-120b",
        "output": "outputs/train-result-gpt-oss/single_preds9.csv",
    },
]
...
if __name__ == "__main__":
    ...
    os.makedirs("outputs/train-result-gpt-oss", exist_ok=True)
